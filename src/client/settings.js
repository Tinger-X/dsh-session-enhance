...
/** 把消息文本中的 Markdown 图片引用（`![alt](/describe-image/raw/…)`、内联 `data:image/…`）渲染为 <img>，其余文本原样保留。 */
...
function PreviewMessageLine({ message, isUser, toggle, collapsed, t }) {
	...
	const bubble = (0, react_jsx_runtime.jsx)("div", {
		...
		children: (0, react_jsx_runtime.jsx)("div", { className: "dshse_previewText", children: collapsed ? message.text : previewContentNodes(message.text) })
	});
