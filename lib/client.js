window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function previewContentNodes(text) {
		  ...
		  while ((match = pattern.exec(text)) !== null) {
		    ...
		    const src = match[2];
		    if (src.startsWith("/describe-image/raw/") || src.startsWith("data:image/") || /^https?:\/\//i.test(src)) {
		...
		function PreviewMessageLine({ message, isUser, toggle, collapsed, t }) {
		  ...
		  const bubble = (0, react_jsx_runtime2.jsx)("div", {
		    ...
		    children: (0, react_jsx_runtime2.jsx)("div", { className: "dshse_previewText", children: collapsed ? message.text : previewContentNodes(message.text) })
		  });
