window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const ENHANCE_TABS_CSS = ".dshse_enhance{box-sizing:border-box;width:min(100%,760px);margin:0 auto;padding:0 0 32px}.dshse_enhanceTabs{display:flex;gap:2px;margin-bottom:20px;border-bottom:1px solid var(--dsw-alias-border-l2)}.dshse_enhanceTab{display:inline-flex;align-items:center;min-height:36px;padding:0 14px;color:var(--dsw-alias-label-tertiary);background:transparent;border:0;border-bottom:2px solid transparent;border-radius:8px 8px 0 0;cursor:pointer;font:inherit;font-size:13px;font-weight:500}.dshse_enhanceTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.dshse_enhanceTabActive{color:var(--dsw-alias-state-success-primary);border-bottom-color:var(--dsw-alias-state-success-primary)}";
		/** 基础设置表单样式（家目录输入 + 对话通知开关）。 */
		const BASIC_SETTINGS_CSS = ".dshse_settingsField{margin:0 0 22px}.dshse_settingsFieldLabel{display:block;margin-bottom:6px;color:var(--dsw-alias-label-primary);font-size:13px;font-weight:600;line-height:18px}.dshse_settingsFieldHint{margin:0 0 10px;max-width:42em;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:16px}.dshse_settingsFieldRow{display:flex;align-items:center;gap:8px;max-width:520px}.dshse_settingsInput{box-sizing:border-box;flex:1;min-width:0;height:32px;padding:0 12px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-button-elevated-fill));border:1px solid var(--dsw-alias-border-l2);border-radius:8px;font:inherit;font-size:13px}.dshse_settingsInput:focus{border-color:var(--dsw-alias-label-tertiary);outline:0}.dshse_settingsToggle{display:inline-flex;align-items:center;gap:8px;color:var(--dsw-alias-label-primary);font-size:13px;cursor:pointer}.dshse_settingsToggle input{width:16px;height:16px;margin:0;accent-color:var(--dsw-alias-state-success-primary)}";
		/** 基础设置：`.dsh` 家目录 + 对话通知开关。 */
		function BasicSettings({ getSettings, setSettings, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [(0, react_jsx_runtime.jsx)("style", { children: BASIC_SETTINGS_CSS }), (0, react_jsx_runtime.jsxs)("header", { className: "dshse_settingsHeader", children: [(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("h2", { children: t("settings.basicTab") }), (0, react_jsx_runtime.jsx)("p", { className: "dshse_settingsIntro", children: t("settings.description") })] })] }), (0, react_jsx_runtime.jsx)("div", {
					className: "dshse_settingsGroup",
					children: [(0, react_jsx_runtime.jsxs)("div", { className: "dshse_settingsField", children: [(0, react_jsx_runtime.jsx)("label", { className: "dshse_settingsFieldLabel", htmlFor: "dshse-home-dir", children: t("settings.homeDir") }), (0, react_jsx_runtime.jsx)("p", { className: "dshse_settingsFieldHint", children: t("settings.homeDirHint") }), (0, react_jsx_runtime.jsxs)("div", { className: "dshse_settingsFieldRow", children: [(0, react_jsx_runtime.jsx)("input", { id: "dshse-home-dir", type: "text", className: "dshse_settingsInput", value: homeDirDraft, onChange: (event) => setHomeDirDraft(event.target.value), placeholder: "~/.dsh", spellCheck: false }), (0, react_jsx_runtime.jsx)("button", { type: "button", className: "dshse_settingsAction", disabled: saving, onClick: saveHomeDir, children: t("settings.save") })] })] }), (0, react_jsx_runtime.jsxs)("div", { className: "dshse_settingsField", children: [(0, react_jsx_runtime.jsx)("span", { className: "dshse_settingsFieldLabel", children: t("settings.notify") }), (0, react_jsx_runtime.jsx)("p", { className: "dshse_settingsFieldHint", children: t("settings.notifyHint") }), (0, react_jsx_runtime.jsx)("label", { className: "dshse_settingsToggle", children: [(0, react_jsx_runtime.jsx)("input", { type: "checkbox", checked: settings === null ? true : settings.notifyEnabled, disabled: saving || settings === null, onChange: (event) => setNotify(event.target.checked) }), t("settings.notifyEnabled")] })] })]
				}), error !== null && (0, react_jsx_runtime.jsx)("div", { className: "dshse_settingsError", role: "alert", children: error }), notice !== null && (0, react_jsx_runtime.jsx)("div", { className: "dshse_settingsStatus", role: "status", children: notice })]
			});
		}
		/** 对话增强设置分区：二级页签在「基础设置」与「归档管理」间切换。 */
		function EnhancementSection(props) {
			const [tab, setTab] = (0, react.useState)("basic");
			const { getSettings, setSettings, t } = props;
			return (0, react_jsx_runtime.jsxs)("section", {
				className: "dshse_enhance",
				children: [(0, react_jsx_runtime.jsx)("style", { children: ENHANCE_TABS_CSS }), (0, react_jsx_runtime.jsx)("nav", { className: "dshse_enhanceTabs", role: "tablist", "aria-label": t("settings.manageTitle"), children: [(0, react_jsx_runtime.jsx)("button", { type: "button", role: "tab", "aria-selected": tab === "basic", className: tab === "basic" ? "dshse_enhanceTab dshse_enhanceTabActive" : "dshse_enhanceTab", onClick: () => setTab("basic"), children: t("settings.basicTab") }), (0, react_jsx_runtime.jsx)("button", { type: "button", role: "tab", "aria-selected": tab === "archive", className: tab === "archive" ? "dshse_enhanceTab dshse_enhanceTabActive" : "dshse_enhanceTab", onClick: () => setTab("archive"), children: t("archives.manageTitle") })] }), tab === "basic" ? (0, react_jsx_runtime.jsx)(BasicSettings, { getSettings, setSettings, t }) : (0, react_jsx_runtime.jsx)(ArchivedSessionsSection, props)]
			});
		}
		...
		*/
		...
		const zh = {
			...
			"settings.notifyHint": "对话需要用户操作或结束时，在未聚焦于该对话时弹出系统提示。",
		...
		const en = {
			...
			"settings.notifyHint": "Show a system notification when a conversation needs attention or finishes while unfocused.",
