window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function previewMarkdown(text, t) {
		  return (0, react_jsx_runtime2.jsx)(_deepseek_ai_dsh_client_ui_primitives2.MarkdownText, {
		    text,
		...
		function previewContentNodes(text, t) {
		  ...
		  while ((match = pattern.exec(text)) !== null) {
		    ...
		    if (src.startsWith("data:image/")) {
		      ...
		      nodes.push((0, react_jsx_runtime2.jsx)("img", {
		...
		function PreviewMessageLine({ message, isUser, toggle, collapsed, t }) {
		  ...
		  const bubble = (0, react_jsx_runtime2.jsx)("div", {
		    ...
		    children: collapsed ? (0, react_jsx_runtime2.jsx)("div", {
		      className: "dshse_previewText",
		      children: (0, _deepseek_ai_dsh_client_ui_primitives2.extractMarkdownPlainText)(message.text)
		    }) : (0, react_jsx_runtime2.jsx)("div", {
		...
		function PreviewTurn({ turn, t }) {
		  ...
		  const [bodyHeight, setBodyHeight] = (0, react2.useState)(null);
		  const bodyRef = (0, react2.useRef)(null);
