window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region dsh-session-manager: typert remote contribution + archived styling
		/**
		* Strict codec shims for the dsh-session-manager Remote descriptors. The
		...
		*/
		const ARCHIVE_MANAGER_REMOTE = {
			package: "dsh-session-manager",
			descriptors: [
				{
					id: "dsh-session-manager#workspaceRegistry/unarchiveSession",
					...
					result: {
						mode: "strict",
						typeSymbol: "dsh-session-manager/types#ArchivedSessionIds",
						schema: archivedSetSchema
					},
					sourceLocation: { file: "dsh-session-manager/lib/workspace.js", line: 1, column: 1 }
				},
				{
					id: "dsh-session-manager#workspaceRegistry/deleteSession",
					service: "workspaceRegistry",
					namespace: "workspaceRegistry",
					...
					result: {
						mode: "strict",
						typeSymbol: "dsh-session-manager/types#Deleted",
						schema: deletedSchema
					},
					sourceLocation: { file: "dsh-session-manager/lib/workspace.js", line: 1, column: 1 }
				},
				{
					id: "dsh-session-manager#workspaceRegistry/unarchiveSessions",
					service: "workspaceRegistry",
					namespace: "workspaceRegistry",
					...
					parameters: [{
						...
						wire: "target",
						source: "json",
						codec: { mode: "strict", typeSymbol: "dsh-session-manager/types#ArchivedBatchTarget", schema: archivedBatchTargetSchema }
					}],
					result: {
						mode: "strict",
						typeSymbol: "dsh-session-manager/types#UnarchivedBatch",
						schema: unarchivedBatchSchema
					},
					sourceLocation: { file: "dsh-session-manager/lib/workspace.js", line: 1, column: 1 }
				},
				{
					id: "dsh-session-manager#workspaceRegistry/deleteArchivedSessions",
					service: "workspaceRegistry",
					namespace: "workspaceRegistry",
					...
					result: {
						mode: "strict",
						typeSymbol: "dsh-session-manager/types#DeletedBatch",
						schema: deletedBatchSchema
					},
					sourceLocation: { file: "dsh-session-manager/lib/workspace.js", line: 1, column: 1 }
				},
				{
					id: "dsh-session-manager#workspaceRegistry/archivedSessionMetadata",
					service: "workspaceRegistry",
					namespace: "workspaceRegistry",
					...
					result: {
						mode: "strict",
						typeSymbol: "dsh-session-manager/types#ArchivedSessionMetadata",
						schema: archivedSessionMetadataSchema
					},
					sourceLocation: { file: "dsh-session-manager/lib/workspace.js", line: 1, column: 1 }
				},
				{
					id: "dsh-session-manager#workspaceRegistry/moveSession",
					service: "workspaceRegistry",
					namespace: "workspaceRegistry",
					method: "moveSession",
					invocation: { kind: "direct" },
					parameters: [{
						...
						source: "json",
						codec: { mode: "strict", typeSymbol: "dsh-session-manager/types#WorkspaceTarget", schema: workspaceTargetSchema }
					}],
					result: {
						mode: "strict",
						typeSymbol: "dsh-session-manager/types#SessionMoved",
						schema: moveSessionSchema
					},
					sourceLocation: { file: "dsh-session-manager/lib/workspace.js", line: 1, column: 1 }
				},
				{
					id: "dsh-session-manager#workspaceRegistry/syncRecords",
					service: "workspaceRegistry",
					namespace: "workspaceRegistry",
					method: "syncRecords",
					invocation: { kind: "direct" },
					...
					result: {
						mode: "strict",
						typeSymbol: "dsh-session-manager/types#SyncRecords",
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify("dsh-session-manager/Archived.module.css") + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-session-manager";
			tag.dataset.pluginCss = "dsh-session-manager/Archived.module.css";
			tag.textContent = ARCHIVED_CSS;
			document.head.appendChild(tag);
		}
		/** PLUS：拖拽修改归属的投放高亮样式（会话拖到别的分组头部时）。 */
		const DND_CSS = ".dsham_sessionDropTarget{outline:2px dashed var(--dsw-alias-accent-strong);outline-offset:2px;border-radius:12px;background:var(--dsw-alias-interactive-bg-hover)}";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify("dsh-session-manager/dnd.module.css") + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-session-manager";
			tag.dataset.pluginCss = "dsh-session-manager/dnd.module.css";
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [groups.length === 0 && (0, react_jsx_runtime.jsx)("div", {
							...
							return (0, react_jsx_runtime.jsxs)("div", {
								className: clsx(WorkspaceBrowser_module_css_default.groupSection, workspaceMarker === "before" && WorkspaceBrowser_module_css_default.workspaceDropBefore, workspaceMarker === "after" && WorkspaceBrowser_module_css_default.workspaceDropAfter, acceptsSessionDrop && sessionDropGroup === group.key && "dsham_sessionDropTarget"),
								onDragOver: (e) => {
		...
		*/
		...
		//#endregion
		//#region dsh-session-manager: settings section
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify("dsh-session-manager/ArchiveSettings.layout.css") + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-session-manager";
			tag.dataset.pluginCss = "dsh-session-manager/ArchiveSettings.layout.css";
		...
		function installArchivedNavIconSwap() {
			...
			const apply = () => {
				for (const button of document.querySelectorAll("button")) {
					if (button.dataset.dshamNavIconPatched === "1") continue;
					...
					button.dataset.dshamNavIconPatched = "1";
				}
			};
			apply();
		...
		*/
		...
		/**
		* Plugin body: mount the dsh-session-manager Remote contribution, then
		...
		*/
		function applyWorkspaceBrowser(ctx) {
			...
			ctx.effect(() => installArchivedNavIconSwap(), "dsh-session-manager: archived nav icon");
			...
			const unarchiveSession = async (sessionId) => {
				...
				if (registry === void 0) throw new Error("dsh-session-manager remote service is unavailable");
		...
		//#endregion
		/** Pure derivation surface for dsh-session-manager self-tests (no-op for the runtime). */
		exports.__test = {
			displayTitle,
			sessionVisible,
